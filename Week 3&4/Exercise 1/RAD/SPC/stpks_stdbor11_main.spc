CREATE OR REPLACE PACKAGE  stpks_stdbor11_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdbor11_main.spc
  **
...
TYPE ty_stdbor11 IS RECORD (
     v_sttm_bora1_master     sttm_bora1_master%ROWTYPE,
...
/
CREATE OR REPLACE SYNONYM stpkss_stdbor11_main FOR stpks_stdbor11_main
/