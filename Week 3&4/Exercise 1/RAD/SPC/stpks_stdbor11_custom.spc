CREATE OR REPLACE PACKAGE  stpks_stdbor11_custom AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdbor11_custom.spc
  **
...
/
CREATE OR REPLACE SYNONYM stpkss_stdbor11_custom FOR stpks_stdbor11_custom
/