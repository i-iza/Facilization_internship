CREATE OR REPLACE PACKAGE  stpks_stdbora4_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdbora4_main.spc
  **
...
TYPE ty_tb_v_sttm_bora4_detail IS TABLE OF sttm_bora4_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_stdbora4 IS RECORD (
     v_sttm_bora4_master     sttm_bora4_master%ROWTYPE,
     v_sttm_bora4_detail    ty_tb_v_sttm_bora4_detail,
...
/
CREATE OR REPLACE SYNONYM stpkss_stdbora4_main FOR stpks_stdbora4_main
/