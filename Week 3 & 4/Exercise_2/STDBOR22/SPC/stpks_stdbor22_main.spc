CREATE OR REPLACE PACKAGE  stpks_stdbor22_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdbor22_main.spc
  **
...
TYPE ty_tb_v_sttm_bor22_detail IS TABLE OF sttm_bor22_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_stdbor22 IS RECORD (
     v_sttm_bor22_master     sttm_bor22_master%ROWTYPE,
     v_sttm_bor22_detail    ty_tb_v_sttm_bor22_detail,
...
/
CREATE OR REPLACE SYNONYM stpkss_stdbor22_main FOR stpks_stdbor22_main
/